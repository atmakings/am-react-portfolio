...
export default class BlogForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      content: "",
      featured_image: "",
      apiUrl: "https://andrewmakings.devcamp.space/portfolio/portfolio_blogs",
      apiAction: "post",
    };
  ...
  componentWillMount() {
    const { editMode, blog } = this.props;
    if (editMode) {
      const { id, title, blog_status, content } = blog;
      ...
      this.setState({
        ...
        blog_status,
        content,
        apiUrl: `https://andrewmakings.devcamp.space/portfolio/portfolio_blogs/${id}`,
        apiAction: "patch",
      });
    }
  }
